...
def create_app():
    ...
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////Users/damonrodriguez/Desktop/DSPT7-Twitoff/twitoff.sqlite3'  # sqlite:////Users/damonrodriguez/Desktop/DSPT7-Twitoff/twitoff.sqlite3 (for absolute path)
